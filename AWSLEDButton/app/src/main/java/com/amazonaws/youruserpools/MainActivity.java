...
import com.tistory.joondong.awsledbutton.AWSLEDButtonActivity;
import com.tistory.joondong.awsledbutton.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void launchUser() {
        ...
        Intent userActivity = new Intent(this, AWSLEDButtonActivity.class);
        userActivity.putExtra("name", username);
        startActivityForResult(userActivity, 4);
    }
    ...
    // called when user name and password authentication completed.
    AuthenticationHandler authenticationHandler = new AuthenticationHandler() {
        ...
        public void onSuccess(CognitoUserSession cognitoUserSession, CognitoDevice device) {
            ...
            if(AppHelper.updateCredentialsProvider()) { // TODO : 유지?
        ...
        // called when e-mail authentication completed.
        @Override
